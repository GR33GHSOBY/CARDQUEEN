...
def loginSC():
	...
	if username =="card" and password =="queen":
	...
	try:
		...
		if 'save-device' in url:
			try:
				...
				os.system('xdg-open https://www.youtube.com/Gangsing')
				menu()
